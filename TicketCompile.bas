...
Sub CalculateStockData()
    ...
    Dim YearlyChangeColor As Long ' Variable to store the cell color
    ...
    For Each ws In ThisWorkbook.Worksheets
        ...
        For i = 2 To LastRow
            If ws.Cells(i + 1, 1).Value <> Ticker Then
                ...
                ws.Cells(SummaryRow, 10).Interior.Color = YearlyChangeColor ' Apply cell color
                ws.Cells(SummaryRow, 11).Value = Format(PercentChange, "0.00") & "%" ' Format PercentChange
            ...
            Else
                TotalVolume = TotalVolume + ws.Cells(i, 7).Value ' Accumulate TotalVolume for the same ticker
            End If
        Next i
        
        ' Output Greatest % Increase, Greatest % Decrease, and Greatest Total Volume in columns N and O
